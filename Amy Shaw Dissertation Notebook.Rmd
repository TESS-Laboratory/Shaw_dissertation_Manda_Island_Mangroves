...
## Amy Shaw Dissertation Code Script
...
### Importing all the data from the Global Mangrove Watch 3.0 dataset as csv files. 
...
#### Convert Mangrove cover to hectares as its currently in sq meters 
...
#### Convert into a data.table in order to create tables and charts with the data
...
Create a Line plot showing a time-series for Lamu County and Manda
